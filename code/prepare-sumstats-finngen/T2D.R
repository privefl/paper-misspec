...
file <- R.utils::gunzip("tmp-data/summary_stats_finngen_R6_E4_DM2.gz",
...
# 16,355,271 variants to be matched.
...
table(info_snp2$n_case)    # all 41,245
table(info_snp2$n_control) # all 215,160

info_snp3 <- info_snp2 %>%
  select(!starts_with("n_")) %>%
  mutate(n_eff = 4 / (1 / 41245 + 1 / 215160),
