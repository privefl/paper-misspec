...
file <- R.utils::gunzip("tmp-data/summary_stats_finngen_R6_C3_PROSTATE.gz",
...
# 16,354,079 variants to be matched.
...
table(info_snp2$n_case)    # all 8709
table(info_snp2$n_control) # all 104,635

info_snp3 <- info_snp2 %>%
  select(!starts_with("n_")) %>%
  mutate(n_eff = 4 / (1 / 8709 + 1 / 104635),
