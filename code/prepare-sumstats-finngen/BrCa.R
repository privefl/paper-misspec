...
file <- R.utils::gunzip("tmp-data/summary_stats_finngen_R6_C3_BREAST.gz",
...
# 16,354,723 variants to be matched.
...
table(info_snp2$n_case)    # all 11,573
table(info_snp2$n_control) # all 135,488

info_snp3 <- info_snp2 %>%
  select(!starts_with("n_")) %>%
  mutate(n_eff = 4 / (1 / 11573 + 1 / 135488),
