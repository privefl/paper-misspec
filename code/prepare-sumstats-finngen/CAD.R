...
file <- R.utils::gunzip("tmp-data/summary_stats_finngen_R6_I9_CORATHER.gz",
...
# 16,355,268 variants to be matched.
...
table(info_snp2$n_case)    # all 28,598
table(info_snp2$n_control) # all 222,551

info_snp3 <- info_snp2 %>%
  select(!starts_with("n_")) %>%
  mutate(n_eff = 4 / (1 / 28598 + 1 / 222551),
