...
In the real data applications hereinafter, we choose to use the first correction, ``sqrt\_info'', which is simple because it is equivalent to post-processing PGS effects by multiplying them by $\sqrt{\text{INFO}}$. [TODO: TRY THEM ALL AGAIN? AND META-ANALYZE (BRCA AND T1D)?]
...
[TODO: PRS-CS REGU + SMALL LD REF UNMATCHED WITH ANCESTRY + LD BLOCKS]
[LD BLOCKS MAINLY FOR SCALA BUT SHOW THAT USEFUL FOR ROBUSTNESS]
