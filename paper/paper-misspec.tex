...
\begin{figure}[!h]
	\centerline{\includegraphics[width=0.67\textwidth]{res-cad}}
...
\begin{figure}[!h]
	\centerline{\includegraphics[width=0.67\textwidth]{res-vitaminD}}
...
We use GWAS summary statistics for five disease endpoints from FinnGen (release 6, \cite{kurki2022finngen}), namely breast and prostate cancers (BrCa and PrCa), coronary artery disease (CAD), type 1 and type 2 diabetes (T1D and T2D).
