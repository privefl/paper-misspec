...
Results for LDpred2-auto are the same as with LDpred2-inf, as it always converges to an infinitesimal model (p = 1) in these simulations.
...
[TODO: COMPLETE WITH LOOK AT EACH OF THEM]
...
Among genetic variants with a minor allele frequency larger than 0.01 and an imputation INFO score larger than 0.3, we sample 20,000 of them according to the inverse of the INFO score density so that they have varying levels of imputation accuracy (Figure \ref{fig:hist-info}).
