...
In addition {\color{red}to the LD reference panel of Northwestern European ancestry}, we design an alternative reference panel based on 10,000 individuals from South Europe by using the ``Italy'' center defined in \cite{prive2021high}.
...
Third, the LD reference panel should be as close as possible (in terms of genetic ancestry) as the data used to derive the GWAS. In case of any doubt, ancestry proportions can be estimated from GWAS allele frequencies using the method derived in \cite{prive2021using}.
