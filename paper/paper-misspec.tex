...
Second, it may lead to an improved prediction when building polygenic scores using one of the proposed corrections.
...
\begin{table}[h]
	...
	\begin{tabular}{|l||c|c|c||c|c|}
		...
		Depression (MDD) [without UKBB] & \cite{wray2018genome} & 110,463 & ~~9,874,289 & 1,049,455 & 0.968 \\
