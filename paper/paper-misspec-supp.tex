...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{Multiple results (squared correlation r2 between polygenic score and phenotype) over a grid of parameters ($\lambda$ and $\delta$) for lassosum2 in one of the simulations with misspecified GWAS sample sizes (N). The top subfigure is using the maximum N, whereas the bottom subfigure is using the imputed N.  Missing points represent models that were detected as divergent.}
...
\begin{figure}[p]
	...
	\end{subfigure}
	\caption{Multiple results (squared correlation r2 between polygenic score and phenotype) over a grid of parameters (the SNP heritability h2 and the proportion of causal variants p) for LDpred2(-grid) in one of the simulations with misspecified GWAS sample sizes (N). The top subfigure is using the maximum N, whereas the bottom subfigure is using the imputed N. Note that the small h2 values (0.002, 0.02, 0.06) were added and are part of the method we call ``LDpred2-low-h2'' in the main text. Missing points represent models that were detected as divergent.}
...
\begin{figure}[p]
	...
	\caption{Raw partial correlations (for \textit{all} models) for predicting CAD in the UK Biobank from external summary statistics.}
	\label{fig:res_cad}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.75\textwidth]{res-mdd}}
	\caption{Raw partial correlations (for \textit{all} models) for predicting MDD in the UK Biobank from external summary statistics.}
	\label{fig:res_mdd}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.75\textwidth]{res-prca}}
	\caption{Raw partial correlations (for \textit{all} models) for predicting PRCA in the UK Biobank from external summary statistics.}
	\label{fig:res_prca}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.95\textwidth]{res-t1d}}
	\caption{Raw partial correlations (for \textit{all} models) for predicting T1D in the UK Biobank from external summary statistics.}
	\label{fig:res_t1d}
\end{figure}
...
\begin{figure}[p]
	...
	\caption{Raw partial correlations (for \textit{all} models and \textit{all} sets) for predicting BRCA in the UK Biobank from external summary statistics.}
	\label{fig:res_brca_all}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.9\textwidth]{res-all-cad}}
	\caption{Raw partial correlations (for \textit{all} models and \textit{all} sets) for predicting CAD in the UK Biobank from external summary statistics.}
	\label{fig:res_cad_all}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.9\textwidth]{res-all-mdd}}
	\caption{Raw partial correlations (for \textit{all} models and \textit{all} sets) for predicting MDD in the UK Biobank from external summary statistics.}
	\label{fig:res_mdd_all}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.9\textwidth]{res-all-prca}}
	\caption{Raw partial correlations (for \textit{all} models and \textit{all} sets) for predicting PRCA in the UK Biobank from external summary statistics.}
	\label{fig:res_prca_all}
\end{figure}

\begin{figure}[p]
	\centerline{\includegraphics[width=0.95\textwidth]{res-all-t1d}}
	\caption{Raw partial correlations (for \textit{all} models and \textit{all} sets) for predicting T1D in the UK Biobank from external summary statistics.}
